...
annotate!(x[1] - 0.1, x[2] + 0.2, text("X", :black, 12))
...
annotate!(z[1] - 0.1, z[2] + 0.1, text("Z", :black, 12))
...
annotate!(r1[1] - 0.1, r1[2] + 0.2, text("R1", :black, 12))
...
annotate!(r2[1] - 0.1, r2[2] + 0.2, text("R2", :black, 12))
...
annotate!(proposal[1] - 0.1, proposal[2] + 0.1, text("X*", :black, 12))
